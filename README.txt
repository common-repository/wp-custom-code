...
2. With CodeMirror it's easier to type your code
3. We added the pt_BR version.
4. The code is not replicated on every page.
5. Add the address of the library you want to add.
